...
def make_env(cfg, test=False,panda_gym=True):
    ...
    if panda_gym:
        ...
        env = panda_image.PandaObsWrapper(env_1, cfg.seed,frame_skip=cfg.action_repeat,k=cfg.frame_stack,img_size=84,greyscale=True)
    if not panda_gym:
        if test:
...
class Workspace(object):
    def __init__(self, cfg):
        ...
        # print(type(self.env.observation_space.shape))
